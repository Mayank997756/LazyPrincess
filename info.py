...
REQ_CHANNEL = environ.get("REQ_CHANNEL", '-1001916038880')
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','mayank4664') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','blackmovies0987') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','mayank4664') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','mayank4664')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "moviesdemandgroup123") #[ without @ ]
